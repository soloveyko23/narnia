    ...
    (() => {
        ...
        function showMore() {
            window.addEventListener("load", (function(e) {
                ...
                function initItem(showMoreBlock, matchMedia = false) {
                    ...
                    const styleElement = document.getElementById("showmore-styles") || document.createElement("style");
                    if (!document.getElementById("showmore-styles")) {
                        styleElement.id = "showmore-styles";
                        styleElement.textContent = `\n\t\t\t\t\t.tabs-block__content > ._showmore-hidden {\n\t\t\t\t\t\tdisplay: none !important;\n\t\t\t\t\t}\n\t\t\t\t\t[data-showmore-button]._showmore-hidden {\n\t\t\t\t\t\tdisplay: none !important;\n\t\t\t\t\t}\n\t\t\t\t`;
                        document.head.append(styleElement);
                    }
                    if (!showMoreBlock.hasAttribute("data-showmore") && showMoreBlock.querySelector("[data-showmore-content]") && showMoreBlock.querySelector("[data-showmore-button]")) {
                        showMoreBlock.setAttribute("data-showmore", "items");
                        console.log('Fixed: Adding data-showmore="items" to parent block:', showMoreBlock);
                    }
                    if (showMoreType === "items") {
                        const childrenElements = Array.from(showMoreContent.children);
                        const childrenCount = childrenElements.length;
                        let showMoreTypeValue;
                        if (showMoreContent.dataset.showmoreContentItems) showMoreTypeValue = parseInt(showMoreContent.dataset.showmoreContentItems); else if (showMoreContent.dataset.showmoreContent) showMoreTypeValue = parseInt(showMoreContent.dataset.showmoreContent); else showMoreTypeValue = 3;
                        if (childrenCount > showMoreTypeValue) {
                            needsShowMore = true;
                            childrenElements.forEach(((item, index) => {
                                if (index >= showMoreTypeValue) item.classList.add("_showmore-hidden"); else item.classList.remove("_showmore-hidden");
                            }));
                            showMoreButton.hidden = false;
                            showMoreButton.classList.remove("_showmore-hidden");
                        } else {
                            needsShowMore = false;
                            childrenElements.forEach((item => {
                                item.classList.remove("_showmore-hidden");
                            }));
                            showMoreButton.hidden = true;
                            showMoreButton.classList.add("_showmore-hidden");
                        }
                        if (needsShowMore) showMoreBlock.classList.add("_showmore-items"); else showMoreBlock.classList.remove("_showmore-items");
                        console.log("ShowMore Items Direct:", {
                            parentBlock: showMoreBlock,
                            childrenCount,
                            showMoreTypeValue,
                            needsShowMore,
                            hiddenElements: childrenElements.filter((el => el.classList.contains("_showmore-hidden"))).length
                        });
                    } else {
                        const originalHeight = getOriginalHeight(showMoreContent);
                        const hiddenHeightCalc = getHeight(showMoreBlock, showMoreContent);
                        if (originalHeight > hiddenHeightCalc) {
                            needsShowMore = true;
                            const hiddenHeight = getHeight(showMoreBlock, showMoreContent);
                            const isActive = showMoreBlock.classList.contains("_showmore-active");
                            const targetHeight = isActive ? originalHeight : hiddenHeight;
                            _slideUp(showMoreContent, 0, targetHeight);
                            showMoreButton.hidden = false;
                            showMoreButton.classList.remove("_showmore-hidden");
                        } else {
                            _slideDown(showMoreContent, 0, originalHeight);
                            showMoreButton.hidden = true;
                            showMoreButton.classList.add("_showmore-hidden");
                        }
                    }
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if (showMoreType === "items") {
                        ...
                        if (showMoreTypeValue > 1) rowGap ? hiddenHeight += (Math.min(showMoreItems.length, showMoreTypeValue) - 1) * rowGap : null;
                    } else {
                ...
                function showMoreActions(e) {
                    ...
                    if (targetType === "click") {
                        if (targetEvent.closest("[data-showmore-button]")) {
                            ...
                            if (!showMoreBlock) {
                                console.error("Showmore: Could not find parent [data-showmore] for button:", showMoreButton);
                                return;
                            }
                            const showMoreContent = showMoreBlock.querySelector("[data-showmore-content]");
                            if (!showMoreContent) {
                                console.error("Showmore: Could not find content [data-showmore-content] inside block:", showMoreBlock);
                                return;
                            }
                            ...
                            if (!showMoreContent.classList.contains("_slide")) {
                                ...
                                if (showMoreType === "items") {
                                    ...
                                    let showMoreTypeValue;
                                    if (showMoreContent.dataset.showmoreContentItems) showMoreTypeValue = parseInt(showMoreContent.dataset.showmoreContentItems); else if (showMoreContent.dataset.showmoreContent) showMoreTypeValue = parseInt(showMoreContent.dataset.showmoreContent); else showMoreTypeValue = 3;
                                    if (showMoreBlock.classList.contains("_showmore-active")) childrenElements.forEach((item => {
                                        item.classList.remove("_showmore-hidden");
                                    })); else childrenElements.forEach(((item, index) => {
                                        if (index >= showMoreTypeValue) item.classList.add("_showmore-hidden");
                                    }));
                                } else {
                                    const hiddenHeight = getHeight(showMoreBlock, showMoreContent);
                                    showMoreBlock.classList.contains("_showmore-active") ? _slideDown(showMoreContent, showMoreSpeed, hiddenHeight) : _slideUp(showMoreContent, showMoreSpeed, hiddenHeight);
                                }
                            }
                        }
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new swiper_core_Swiper(".main-slider__slider", {
                ...
                new swiper_core_Swiper(".promotional-offers__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    ...
                    pagination: {
                        el: ".promotional-offers__slider .swiper-pagination",
                        clickable: true
                    },
                    breakpoints: {
                        320: {
                            ...
                            spaceBetween: 8,
                            navigation: {
                                prevEl: ".promotional-offers .section-header .swiper-button-prev",
                                nextEl: ".promotional-offers .section-header .swiper-button-next"
                            }
                        },
                        768: {
                            slidesPerView: 3,
                            spaceBetween: 10,
                            navigation: {
                                prevEl: ".promotional-offers .swiper-button-prev",
                                nextEl: ".promotional-offers .swiper-button-next"
                            }
                        },
                        992: {
                            slidesPerView: 4,
                ...
                new swiper_core_Swiper(".other-products__slider", {
                    ...
                    pagination: {
                        el: ".other-products__slider .swiper-pagination",
                        clickable: true
                    },
                    breakpoints: {
                        320: {
                            ...
                            spaceBetween: 8,
                            navigation: {
                                prevEl: ".other-products .section-header .swiper-button-prev",
                                nextEl: ".other-products .section-header .swiper-button-next"
                            }
                        },
                        768: {
                            slidesPerView: 3,
                ...
                new swiper_core_Swiper(".product-page__slider", {
                    ...
                    pagination: {
                        el: ".product-page__slider .swiper-pagination",
                        clickable: true,
                        type: "fraction"
                    }
                });
                new swiper_core_Swiper(".popup-info-product__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    navigation: {
                        prevEl: ".popup-info-product .slider-navigation .swiper-button-prev",
                        nextEl: ".popup-info-product .slider-navigation .swiper-button-next"
                    },
                    pagination: {
                        el: ".popup-info-product__slider .swiper-pagination",
                        clickable: true,
                        type: "fraction"
                    },
                    on: {}
                });
                new swiper_core_Swiper(".hots-sales__slider", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    ...
                    pagination: {
                        el: ".hots-sales__slider .swiper-pagination",
                        clickable: true
                    },
                    breakpoints: {
                        320: {
                            ...
                            spaceBetween: 8,
                            navigation: {
                                prevEl: ".hots-sales .section-header .swiper-button-prev",
                                nextEl: ".hots-sales .section-header .swiper-button-next"
                            }
                        },
                        768: {
                            slidesPerView: 3,
                            spaceBetween: 10,
                            navigation: {
                                prevEl: ".hots-sales .swiper-button-prev",
                                nextEl: ".hots-sales .swiper-button-next"
                            }
                        },
                        992: {
                            slidesPerView: 4,
...
***************************************************************************** */
        ...
        function initShowMoreItems() {
            const showMoreBlocks = document.querySelectorAll("[data-showmore-item]");
            if (!showMoreBlocks.length) return;
            showMoreBlocks.forEach((block => {
                initSingleShowMoreBlock(block);
            }));
        }
        function initSingleShowMoreBlock(block) {
            const content = block.querySelector("[data-showmore-item-content]");
            const button = block.querySelector("[data-showmore-item-button]");
            const items = block.querySelectorAll("[data-showmore-item-content] > ul > li");
            if (!content || !button || !items.length) return;
            const itemsToShow = parseInt(content.getAttribute("data-showmore-item-content"), 10);
            ...
            items.forEach(((item, index) => {
                if (index >= itemsToShow) item.style.display = "none"; else item.style.display = "";
            }));
            button.removeEventListener("click", button._clickHandler);
            button._clickHandler = () => {
                block.classList.toggle("show-all");
                if (block.classList.contains("show-all")) items.forEach((item => {
                    item.style.display = "";
        ...
        function initMutationObserver() {
            const observer = new MutationObserver((mutations => {
                mutations.forEach((mutation => {
                    if (mutation.type === "attributes" && mutation.attributeName === "data-showmore-item-content") {
                        const block = mutation.target.closest("[data-showmore-item]");
                        if (block) initSingleShowMoreBlock(block);
                    }
                }));
            }));
            const contentElements = document.querySelectorAll("[data-showmore-item-content]");
        ...
        function dropdown() {
            ...
            if (dropdowns.length) {
                ...
                document.addEventListener("click", (e => {
                    const targetElement = e.target;
                    if (targetElement.closest("[data-dropdown-toggle]")) {
                        const toggleEl = targetElement.closest("[data-dropdown-toggle]");
                        const dropdownId = toggleEl.dataset.dropdownToggle;
                        const currentDropdown = document.querySelector(`[data-dropdown="${dropdownId}"]`);
                        if (currentDropdown) {
                            e.preventDefault();
                            const animSpeed = currentDropdown.dataset.dropdownAnim ? parseInt(currentDropdown.dataset.dropdownAnim) : 0;
                            if (currentDropdown.hasAttribute("data-dropdown-single")) dropdowns.forEach((dropdown => {
                                if (dropdown !== currentDropdown && dropdown.classList.contains("_open")) {
                                    const dropdownAnimSpeed = dropdown.dataset.dropdownAnim ? parseInt(dropdown.dataset.dropdownAnim) : 0;
                                    const toggleId = dropdown.dataset.dropdown;
                                    const toggle = document.querySelector(`[data-dropdown-toggle="${toggleId}"]`);
                                    if (dropdownAnimSpeed > 0) {
                                        slideDropdownWithDirection(dropdown, "up", dropdownAnimSpeed);
                                        setTimeout((() => {
                            ...
                            toggleEl.classList.toggle("_active");
                            if (!currentDropdown.classList.contains("_open")) {
                                adjustDropdownPosition(currentDropdown, toggleEl);
                                currentDropdown.classList.add("_open");
                                if (animSpeed > 0) slideDropdownWithDirection(currentDropdown, "down", animSpeed); else currentDropdown.style.display = "block";
                                if (currentDropdown.hasAttribute("data-dropdown-outside-close")) document.addEventListener("click", outsideClickHandler);
                            } else {
                                if (animSpeed > 0) {
                                    slideDropdownWithDirection(currentDropdown, "up", animSpeed);
                                    setTimeout((() => {
                    ...
                    if (targetElement.closest("[data-dropdown-close]")) {
                        const closeEl = targetElement.closest("[data-dropdown-close]");
                        const dropdownEl = closeEl.closest("[data-dropdown]");
                        if (dropdownEl) {
                            e.preventDefault();
                            const animSpeed = dropdownEl.dataset.dropdownAnim ? parseInt(dropdownEl.dataset.dropdownAnim) : 0;
                            const toggleEl = document.querySelector(`[data-dropdown-toggle="${dropdownEl.dataset.dropdown}"]`);
                            toggleEl?.classList.remove("_active");
                            if (animSpeed > 0) {
                                slideDropdownWithDirection(dropdownEl, "up", animSpeed);
                                setTimeout((() => {
                                    dropdownEl.classList.remove("_open");
                                }), animSpeed);
                            } else {
                                dropdownEl.classList.remove("_open");
                    ...
                    if (!targetElement.closest("[data-dropdown]") && !targetElement.closest("[data-dropdown-toggle]")) {
                        const openDropdowns = document.querySelectorAll("[data-dropdown]._open");
                        if (openDropdowns.length) openDropdowns.forEach((dropdown => {
                            const animSpeed = dropdown.dataset.dropdownAnim ? parseInt(dropdown.dataset.dropdownAnim) : 0;
                            const toggleEl = document.querySelector(`[data-dropdown-toggle="${dropdown.dataset.dropdown}"]`);
                            toggleEl?.classList.remove("_active");
                            if (animSpeed > 0) {
                                slideDropdownWithDirection(dropdown, "up", animSpeed);
                                setTimeout((() => {
                                    dropdown.classList.remove("_open");
                                }), animSpeed);
                            } else {
                ...
                function prepareDropdowns() {
                    dropdowns.forEach((dropdown => {
                        if (!dropdown.closest(".dropdown-wrapper")) {
                ...
                function slideDropdownWithDirection(dropdown, action, speed) {
                    const wrapper = dropdown.closest(".dropdown-wrapper");
                    if (!wrapper) return;
                    wrapper.classList.contains("up");
                    dropdown.classList.add("_slide");
                    if (action === "down") {
                        dropdown.style.display = "block";
                        _slideDown(dropdown, speed);
                    } else {
                        _slideUp(dropdown, speed);
                        setTimeout((() => {
                            dropdown.classList.remove("_slide");
                        }), speed);
                    }
                }
                function adjustDropdownPosition(dropdown, toggleEl) {
                    const wrapper = dropdown.closest(".dropdown-wrapper");
                    if (!wrapper) return;
                    ...
                    let finalTopRelative;
                    const spaceBelow = viewportHeight - toggleRect.bottom;
                    const spaceAbove = toggleRect.top;
                    if (spaceBelow >= dropdownHeight + offset) finalTopRelative = toggleRect.bottom - wrapperRect.top + offset; else if (spaceAbove >= dropdownHeight + offset) finalTopRelative = toggleRect.top - wrapperRect.top - dropdownHeight - offset; else {
                        let topDoc = viewportHeight - dropdownHeight - offset;
                        if (topDoc < offset) topDoc = offset;
                        finalTopRelative = topDoc - wrapperRect.top;
                    }
                    let finalLeftRelative;
                    let leftAlignedWithToggle = toggleRect.left - wrapperRect.left;
                    if (toggleRect.left + dropdownWidth <= viewportWidth - offset) finalLeftRelative = leftAlignedWithToggle; else {
                        let rightAlignedWithToggle = toggleRect.right - wrapperRect.left - dropdownWidth;
                        if (toggleRect.right - dropdownWidth >= offset) finalLeftRelative = rightAlignedWithToggle; else {
                            let leftDoc = viewportWidth - dropdownWidth - offset;
                            if (leftDoc < offset) leftDoc = offset;
                            finalLeftRelative = leftDoc - wrapperRect.left;
                        }
                    }
                    if (wrapperRect.left + finalLeftRelative < offset) finalLeftRelative = offset - wrapperRect.left;
                    dropdown.style.top = `${finalTopRelative}px`;
                    dropdown.style.left = `${finalLeftRelative}px`;
                    dropdown.style.width = originalStyles.width === "auto" ? "" : originalStyles.width;
                    dropdown.style.opacity = originalStyles.opacity || "1";
                    dropdown.style.pointerEvents = originalStyles.pointerEvents || "auto";
                    dropdown.style.visibility = originalStyles.visibility || "visible";
                }
                function outsideClickHandler(e) {
                    const targetElement = e.target;
                    if (!targetElement.closest("[data-dropdown]") && !targetElement.closest("[data-dropdown-toggle]")) {
                        const openDropdowns = document.querySelectorAll("[data-dropdown]._open[data-dropdown-outside-close]");
                ...
                dropdowns.forEach((dropdown => {
                    if (dropdown.hasAttribute("data-dropdown-open-init")) {
                        const dropdownId = dropdown.dataset.dropdown;
                        const toggleEl = document.querySelector(`[data-dropdown-toggle="${dropdownId}"]`);
                        if (toggleEl) {
                            toggleEl.classList.add("_active");
                            adjustDropdownPosition(dropdown, toggleEl);
                            dropdown.classList.add("_open");
                            if (dropdown.dataset.dropdownAnim) dropdown.style.display = "block";
                        }
                    }
                }));
                window.addEventListener("resize", (() => {
                    ...
                    openDropdowns.forEach((dropdown => {
                        const dropdownId = dropdown.dataset.dropdown;
                        const toggleEl = document.querySelector(`[data-dropdown-toggle="${dropdownId}"]`);
                        if (toggleEl) adjustDropdownPosition(dropdown, toggleEl);
                    }));
                }));
            }
        }
        ...
        if (typeof window !== "undefined") window.initDropdown = dropdown;
        const initRippleEffect = () => {
            if (!document || !document.addEventListener) return;
            if (!document.querySelector("[data-custom-ripple]")) return;
            document.addEventListener("click", (e => {
                const targetItem = e.target;
                if (!targetItem || !targetItem.closest) return;
                if (targetItem.closest("[data-custom-ripple]")) {
                    console.log("targetItem", targetItem);
                    const button = targetItem.closest("[data-custom-ripple]");
                    if (!button) return;
                    const rippleColor = button.dataset.customRipple || "rgba(255, 255, 255, 0.4)";
                    const ripple = document.createElement("span");
                    const diameter = Math.max(button.clientWidth, button.clientHeight);
                    const radius = diameter / 2;
                    ripple.style.width = ripple.style.height = `${diameter}px`;
                    ...
                    ripple.classList.add("ripple");
                    if (button.dataset.customRipple === "once" && button.querySelector(".ripple")) button.querySelector(".ripple").remove();
                    button.appendChild(ripple);
                    const timeOut = getAnimationDuration(ripple);
                    setTimeout((() => {
        ...
        const initCatalog = () => {
            ...
            const catalogBackdrop = catalogMenu.querySelector(".catalog-menu__backdrop");
            const catalogContainer = catalogMenu.querySelector(".catalog-menu__container");
            const catalogInner = catalogMenu.querySelector(".catalog-menu__inner");
            const categoryItems = catalogMenu.querySelectorAll(".catalog-menu__item") || [];
            const subCategories = catalogMenu.querySelectorAll(".catalog-menu__subcategory") || [];
            catalogMenu.querySelectorAll(".catalog-menu__back button");
            ...
            const setVariables = () => {
                try {
                    ...
                    const widget = document.querySelector(".header-widget");
                    if (widget) {
                        const widgetHeight = widget.offsetHeight;
                        document.documentElement.style.setProperty("--widget-height", `${widgetHeight}px`);
                    } else document.documentElement.style.setProperty("--widget-height", "0px");
                    const container = document.querySelector(".header__container");
                    if (container) {
                        const computedStyle = window.getComputedStyle(container);
                        const containerWidth = container.offsetWidth;
                        const containerPadding = computedStyle.paddingLeft;
                        document.documentElement.style.setProperty("--container-width", `${containerWidth}px`);
                        document.documentElement.style.setProperty("--container-padding", containerPadding);
                    }
                } catch (err) {
                    console.error("Ошибка при установке CSS-переменных:", err);
                }
            };
            ...
            const lockBody = () => {
                if (!document.body.classList.contains("body-lock")) try {
                    const scrollbarWidth = getScrollbarWidth();
                    document.body.style.paddingRight = `${scrollbarWidth}px`;
                    document.body.classList.add("body-lock");
                } catch (err) {
                    console.error("Ошибка при блокировке body:", err);
                }
            };
            const unlockBody = () => {
                try {
                    if (document.body.classList.contains("body-lock")) setTimeout((() => {
                        document.body.style.paddingRight = "";
                        document.body.classList.remove("body-lock");
                    }), 200);
                } catch (err) {
                    console.error("Ошибка при разблокировке body:", err);
                }
            };
            const fastActivateCategory = categoryItem => {
                if (!categoryItem || isMobileDevice()) return;
                try {
                    ...
                    const targetSubCategory = document.querySelector(`.catalog-menu__subcategory[data-category="${categoryId}"]`);
                    if (targetSubCategory) {
                        targetSubCategory.style.opacity = "1";
                        targetSubCategory.classList.add("active");
                    }
                } catch (err) {
                    console.error("Ошибка при быстрой активации категории:", err);
                }
            };
            const openCatalog = () => {
                if (isAnimationInProgress || isCatalogOpen || !catalogMenu) return;
                try {
                    ...
                    setTimeout((() => {
                        if (catalogContainer) catalogContainer.classList.add("active");
                        setTimeout((() => {
                            if (catalogInner) catalogInner.classList.add("active");
                            if (!isMobileDevice() && categoryItems.length > 0) {
                                fastActivateCategory(categoryItems[0]);
                    ...
                    isAnimationInProgress = false;
                    console.error("Ошибка при открытии каталога:", err);
                }
            };
            const closeCatalog = () => {
                if (!isCatalogOpen || !catalogMenu) return;
                try {
                    isAnimationInProgress = true;
                    catalogBtns.forEach((btn => btn.classList.remove("_active")));
                    removeDesktopHoverHandlers();
                    if (isMobileDevice()) categoryItems.forEach((item => item.classList.remove("active")));
                    if (catalogInner) catalogInner.classList.remove("active");
                    if (catalogContainer) catalogContainer.classList.remove("active");
                    setTimeout((() => {
                    ...
                    isAnimationInProgress = false;
                    isCatalogOpen = false;
                    console.error("Ошибка при закрытии каталога:", err);
                }
            };
            const handleCategoryHover = e => {
                try {
                    ...
                    if (!categoryItem || categoryItem === activeCategory) return;
                    fastActivateCategory(categoryItem);
                } catch (err) {
                    console.error("Ошибка при обработке наведения:", err);
                }
            };
            const setupDesktopHoverHandlers = () => {
                try {
                    categoryItems.forEach((item => {
                        item.removeEventListener("mouseenter", handleCategoryHover);
                        item.addEventListener("mouseenter", handleCategoryHover);
                    }));
                } catch (err) {
                    console.error("Ошибка при настройке обработчиков ховера:", err);
                }
            };
            const removeDesktopHoverHandlers = () => {
                try {
                    categoryItems.forEach((item => {
                        item.removeEventListener("mouseenter", handleCategoryHover);
                    }));
                } catch (err) {
                    console.error("Ошибка при удалении обработчиков ховера:", err);
                }
            };
            const resetCatalogState = () => {
                try {
                    ...
                    if (subcategoriesContainer) subcategoriesContainer.classList.remove("active");
                    activeCategory = null;
                } catch (err) {
                    console.error("Ошибка при сбросе состояния каталога:", err);
                }
            };
            const toggleMobileCollapse = categoryItem => {
                if (!isMobileDevice() || !categoryItem) return;
                try {
                    ...
                    console.error("Ошибка при переключении мобильного коллапса:", err);
                }
            };
            const handleOutsideClick = e => {
                if (!isCatalogOpen) return;
                try {
                    if (!e.target.closest(".catalog-menu__container") && !e.target.closest(".btn-catalog")) closeCatalog();
                } catch (err) {
                    console.error("Ошибка при обработке клика вне каталога:", err);
                }
            };
            const initEventListeners = () => {
                try {
                    if (catalogBtns.length > 0) catalogBtns.forEach((btn => {
                        btn.addEventListener("click", (e => {
                            e.preventDefault();
                            const isCurrentlyActive = btn.classList.contains("_active");
                            if (!isCurrentlyActive) {
                                if (document.querySelector(".btn-catalog._active")) closeCatalog();
                                openCatalog();
                                btn.classList.add("_active");
                            } else closeCatalog();
                        }));
                    }));
                    if (catalogClose) catalogClose.addEventListener("click", (e => {
                        e.preventDefault();
                        closeCatalog();
                    }));
                    if (catalogBackdrop) catalogBackdrop.addEventListener("click", (e => {
                        e.preventDefault();
                        closeCatalog();
                    }));
                    categoryItems.forEach((item => {
                        item.addEventListener("click", (e => {
                            const isLinkClick = e.target.closest(".catalog-menu__link");
                            if (isLinkClick) {
                                e.preventDefault();
                                e.stopPropagation();
                                if (isLinkClick.hasAttribute("data-prevent-scroll")) {
                                    const scrollPosition = window.pageYOffset || document.documentElement.scrollTop;
                                    setTimeout((() => {
                                        window.scrollTo(0, scrollPosition);
                                    }), 5);
                                }
                                if (isMobileDevice()) toggleMobileCollapse(item); else if (item !== activeCategory) fastActivateCategory(item);
                            }
                        }));
                    }));
                    ...
                    window.addEventListener("resize", (() => {
                        ...
                        resizeTimeout = setTimeout((() => {
                            ...
                            if (wasMobile !== nowMobile && isCatalogOpen) if (nowMobile) {
                                removeDesktopHoverHandlers();
                                categoryItems.forEach((item => item.classList.remove("active")));
                            } else {
                                setupDesktopHoverHandlers();
                                if (!activeCategory && categoryItems.length > 0) fastActivateCategory(categoryItems[0]);
                            }
                        }), 150);
                    }));
                } catch (err) {
                    console.error("Ошибка при инициализации обработчиков событий:", err);
                }
            };
            const init = () => {
                setVariables();
        ...
        const initFilterSidebar = () => {
            try {
                ...
                const sidebarCatalog = document.querySelector(".sidebar-catalog");
                const closeButton = document.querySelector(".sidebar-catalog__close");
                if (!filterButton || !sidebarCatalog) return;
                filterButton.addEventListener("click", (() => {
                    sidebarCatalog.classList.toggle("open");
                    if (sidebarCatalog.classList.contains("open")) document.body.classList.add("body-lock"); else document.body.classList.remove("body-lock");
                }));
                ...
                console.error("Ошибка в функции initFilterSidebar:", error);
            }
        };
        ...
        const initFilterTags = () => {
            try {
                const sidebarCatalog = document.querySelector(".sidebar-catalog");
                if (!sidebarCatalog) return;
                const tagsContainer = sidebarCatalog.querySelector(".sidebar-catalog__tags");
                if (!tagsContainer) return;
                const clearFilterBtns = document.querySelectorAll("[data-clear-filter]");
                const checkboxes = sidebarCatalog.querySelectorAll(".checkbox__input");
                const footerFilter = document.querySelector(".sidebar-catalog__footer");
                if (!checkboxes.length) return;
                const updateVisibility = () => {
                    const tags = tagsContainer.querySelectorAll(".sidebar-catalog__tag");
                    if (tags.length === 0) {
                        tagsContainer.classList.add("!hidden");
                        if (footerFilter) footerFilter.classList.add("!hidden");
                    } else {
                        tagsContainer.classList.remove("!hidden");
                        if (footerFilter) footerFilter.classList.remove("!hidden");
                    }
                };
                const createFilterTag = checkbox => {
                    const label = checkbox.closest(".checkbox-default").querySelector(".checkbox__text");
                    if (!label) return null;
                    const filterText = label.childNodes[0].nodeValue?.trim() || label.textContent.replace(/\s+\d+\s*$/g, "").trim();
                    if (!filterText) return null;
                    const tagElement = document.createElement("button");
                    tagElement.type = "button";
                    tagElement.className = "sidebar-catalog__tag";
                    tagElement.dataset.tagFilter = checkbox.id;
                    tagElement.innerHTML = `\n        <span>${filterText}</span>\n        <div class="sidebar-catalog__tag-remove">\n          <i class="icon-nameclose"></i>\n        </div>\n      `;
                    return tagElement;
                };
                const removeFilterTag = tagId => {
                    const tag = tagsContainer.querySelector(`[data-tag-filter="${tagId}"]`);
                    if (tag) {
                        tag.remove();
                        updateVisibility();
                    }
                ...
                const handleCheckboxChange = e => {
                    ...
                    if (checkbox.checked) {
                        const tag = createFilterTag(checkbox);
                        if (tag) {
                    ...
                    } else removeFilterTag(checkbox.id);
                };
                checkboxes.forEach((checkbox => {
                ...
                if (clearFilterBtns.length > 0) clearFilterBtns.forEach((btn => {
                    btn.addEventListener("click", (e => {
                        e.preventDefault();
                        e.stopPropagation();
                        clearAllFilters();
                ...
                tagsContainer.addEventListener("click", (e => {
                    e.stopPropagation();
                    const tagElement = e.target.closest(".sidebar-catalog__tag");
                    if (!tagElement || !tagElement.dataset.tagFilter || tagElement.classList.contains("sidebar-catalog__clear-filter")) return;
                    const checkboxId = tagElement.dataset.tagFilter;
                ...
                console.error("Ошибка в функции initFilterTags:", error);
            }
        };
        document.addEventListener("DOMContentLoaded", initFilterTags);
        const initRadioContentToggle = () => {
            try {
                const optionsContainers = document.querySelectorAll(".options");
                if (!optionsContainers.length) return;
                const showContent = radioGroup => {
                    const radioInputs = radioGroup.querySelectorAll(".options__input");
                    radioGroup.querySelectorAll(".options-content").forEach((content => {
                        content.style.display = "none";
                    }));
                    radioInputs.forEach((radio => {
                        if (radio.checked && radio.dataset.content) {
                            const contentId = radio.dataset.content;
                ...
                optionsContainers.forEach((container => {
                    ...
                    container.addEventListener("change", (e => {
                        if (e.target.classList.contains("options__input")) showContent(container);
                    }));
                }));
            } catch (error) {
                console.error("Ошибка в функции initRadioContentToggle:", error);
            }
        };
        document.addEventListener("DOMContentLoaded", initRadioContentToggle);
        const initOffcanvas = () => {
            const triggers = document.querySelectorAll("[data-offcanvas-trigger]");
            const htmlElement = document.documentElement;
            if (!triggers.length) return;
            const closeOffcanvas = offcanvasToClose => {
                if (!offcanvasToClose || !offcanvasToClose.classList.contains("offcanvas_open")) return;
                offcanvasToClose.classList.remove("offcanvas_open");
                triggers.forEach((t => t.classList.remove("_active")));
                const anyOtherOpen = document.querySelector(".offcanvas.offcanvas_open");
                if (!anyOtherOpen) {
                    htmlElement.classList.remove("offcanvas-open");
                    htmlElement.classList.remove("lock");
                }
            };
            const closeAllOtherOffcanvas = excludeOffcanvas => {
                const openOffcanvases = document.querySelectorAll(".offcanvas.offcanvas_open");
                openOffcanvases.forEach((offcanvas => {
                    if (offcanvas !== excludeOffcanvas) offcanvas.classList.remove("offcanvas_open");
                }));
            };
            triggers.forEach((trigger => {
                trigger.addEventListener("click", (e => {
                    e.preventDefault();
                    const targetSelector = trigger.getAttribute("data-offcanvas-trigger");
                    if (!targetSelector) {
                        console.error("Offcanvas: Атрибут data-offcanvas-trigger пуст или отсутствует.", trigger);
                        return;
                    }
                    const targetOffcanvas = document.querySelector(targetSelector);
                    if (!targetOffcanvas) {
                        console.error(`Offcanvas: Целевой элемент "${targetSelector}" не найден.`);
                        return;
                    }
                    closeAllOtherOffcanvas(targetOffcanvas);
                    triggers.forEach((t => t.classList.remove("_active")));
                    trigger.classList.add("_active");
                    targetOffcanvas.classList.add("offcanvas_open");
                    htmlElement.classList.add("offcanvas-open");
                    htmlElement.classList.add("lock");
                }));
            }));
            document.addEventListener("click", (e => {
                const openOffcanvas = document.querySelector(".offcanvas.offcanvas_open");
                if (!openOffcanvas) return;
                const target = e.target;
                const closeButton = target.closest("[data-close]");
                if (closeButton && openOffcanvas.contains(closeButton)) {
                    e.preventDefault();
                    closeOffcanvas(openOffcanvas);
                    return;
                }
                const contentPart = openOffcanvas.querySelector(".offcanvas__content");
                if (contentPart && !contentPart.contains(target) && !target.closest("[data-offcanvas-trigger]")) closeOffcanvas(openOffcanvas);
            }));
            document.addEventListener("keydown", (e => {
                if (e.key === "Escape") {
                    const openOffcanvas = document.querySelector(".offcanvas.offcanvas_open");
                    if (openOffcanvas) closeOffcanvas(openOffcanvas);
                }
            }));
        };
        initOffcanvas();
        const checkFooterVisibility = () => {
            ...
            if (!footer || !headerWidget || window.innerWidth > 768) return;
            const footerRect = footer.getBoundingClientRect();
            const windowHeight = window.innerHeight;
            if (footerRect.top < windowHeight) {
                headerWidget.style.opacity = "0";
                headerWidget.style.pointerEvents = "none";
            } else {
                headerWidget.style.opacity = "1";
                headerWidget.style.pointerEvents = "auto";
            }
        };
        let scrollTimeout;
        window.addEventListener("scroll", (() => {
            clearTimeout(scrollTimeout);
            scrollTimeout = setTimeout(checkFooterVisibility, 50);
        }));
